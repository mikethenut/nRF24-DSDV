...
\title[Naslov na kratko]{Naslov predstavitve} % The short title appears at the bottom of every slide, the full title is only on the title page

\author[Bartol, Rajh]{Tomaž Bartol, Mihael Rajh} % Your name
...
\frametitle{Uvod}
\begin{itemize}
\item Za seminarsko sva se odločila ker...
\end{itemize}
\end{frame}
